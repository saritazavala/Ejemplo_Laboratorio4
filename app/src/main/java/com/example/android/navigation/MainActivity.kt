...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = DataBindingUtil.setContentView<ActivityMainBinding>(this, R.layout.fragment_title)
    }

    fun abrirSiguiente(view: View){
    val boton: Button = findViewById<Button>(R.id.playButton)
